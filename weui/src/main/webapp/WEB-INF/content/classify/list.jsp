...
<div class="wy-content">
  ...
  <section class="menu-right padding-all j-content">
    <h5>酒水食品</h5>
    <ul>
      <li class="w-3"><a href="${pageContext.request.contextPath}/goods/list.do"></a> <img src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/upload/pro3.jpg"><span>酒水食品</span></li>
      <li class="w-3"><a href="${pageContext.request.contextPath}/goods/list.do"></a> <img src="${pageContext.request.contextPath}/upload/pro3.jpg"><span>酒水食品</span></li>
      <li class="w-3"><a href="${pageContext.request.contextPath}/goods/list.do"></a> <img src="${pageContext.request.contextPath}/upload/pro3.jpg"><span>酒水食品</span></li>
      <li class="w-3"><a href="${pageContext.request.contextPath}/goods/list.do"></a> <img src="${pageContext.request.contextPath}/upload/pro3.jpg"><span>酒水食品</span></li>
      <li class="w-3"><a href="${pageContext.request.contextPath}/goods/list.do"></a> <img src="${pageContext.request.contextPath}/upload/pro3.jpg"><span>酒水食品</span></li>
      <li class="w-3"><a href="${pageContext.request.contextPath}/goods/list.do"></a> <img src="${pageContext.request.contextPath}/upload/pro3.jpg"><span>酒水食品</span></li>
