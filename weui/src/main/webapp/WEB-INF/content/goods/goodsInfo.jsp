    ...
    <div class="weui-tab__bd proinfo-tab-con">
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        ...
        <div class="swiper-container swiper-zhutu">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="${pageContext.request.contextPath}/upload/zhutu01.jpg" /></div>
            <div class="swiper-slide"><img src="${pageContext.request.contextPath}/upload/zhutu02.jpg" /></div>
            <div class="swiper-slide"><img src="${pageContext.request.contextPath}/upload/zhutu03.jpg" /></div>
            <div class="swiper-slide"><img src="${pageContext.request.contextPath}/upload/zhutu04.jpg" /></div>
            <div class="swiper-slide"><img src="${pageContext.request.contextPath}/upload/zhutu05.jpg" /></div>
          </div>
        ...
        <div class="wy-media-box2 weui-media-box_text">
          <div class="weui-media-box_appmsg">
            ...
            <div class="weui-media-box__bd">
              ...
              <div class="yhq-btn clear"><a href="#">去领券</a></div>
            </div>
          </div>
        </div>
        <div class="wy-media-box2 weui-media-box_text">
      ...
      <div id="tab2" class="weui-tab__bd-item ">
        <div class="pro-detail">
          <img src="${pageContext.request.contextPath}/upload/xq1.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq2.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq3.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq4.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq5.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq6.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq7.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq8.jpg" />
          <img src="${pageContext.request.contextPath}/upload/xq9.jpg" />
        </div>
      </div>
      <div id="tab3" class="weui-tab__bd-item">
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            <div class="weui-cell nopd weui-cell_access">
              <div class="weui-cell__hd"><img src="${pageContext.request.contextPath}/upload/headimg.jpg" alt="" style="width:20px;margin-right:5px;display:block"></div>
            ...
            <ul class="weui-uploader__files clear mg-com-img">
                <li class="weui-uploader__file" style="background-image:url(${pageContext.request.contextPath}/upload/pro3.jpg)"></li>
                <li class="weui-uploader__file" style="background-image:url(${pageContext.request.contextPath}/upload/pro3.jpg)"></li>
                <li class="weui-uploader__file" style="background-image:url(${pageContext.request.contextPath}/upload/pro3.jpg)"></li>
            </ul>
          </div>
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            ...
            <p class="weui-media-box__desc">面料不错，码数也正常  男朋友面料不错，码数也正常  男朋友穿的面料不错，码数也正常  男朋友穿的穿的很合适。</p>
            <ul class="weui-uploader__files clear mg-com-img">
                <li class="weui-uploader__file" style="background-image:url(${pageContext.request.contextPath}/upload/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-uploader__file" style="background-image:url(${pageContext.request.contextPath}/upload/ban2.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-uploader__file" style="background-image:url(${pageContext.request.contextPath}/upload/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
            </ul>
          </div>
        </div>
      ...
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="${pageContext.request.contextPath}/shopcart/list.do" class="weui-btn weui-btn_primary">去购物车结算</a>
  ...
  <div class="weui-popup__modal">
    ...
    <div class="modal-content">
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="${pageContext.request.contextPath}/orders/addShopcart.do?goodsId=1" class="weui-btn weui-btn_primary">立即购买</a>
            <a href="javascript:;" class="weui-btn weui-btn_default close-popup">不，我再看看</a>
          </p>
        </div>
      </div>
