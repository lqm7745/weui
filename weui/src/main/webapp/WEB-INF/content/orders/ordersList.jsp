    ...
    <div class="weui-tab__bd proinfo-tab-con" style="padding-top:87px;">
        ...
        <div class="weui-panel weui-panel_access">
          ...
          <div class="weui-panel__ft">
            <div class="weui-cell weui-cell_access weui-cell_link oder-opt-btnbox">
              <a href="javascript:;" class="ords-btn-dele">删除订单</a><a href="${pageContext.request.contextPath}/goods/comment.do?goodsId=1" class="ords-btn-com">评价</a>
            </div>    
          </div>
        </div>
      ...
      <div id="tab2" class="weui-tab__bd-item">
        ...
        <div class="weui-panel weui-panel_access">
          ...
          <div class="weui-panel__ft">
            <div class="weui-cell weui-cell_access weui-cell_link oder-opt-btnbox">
              <a href="javascript:;" class="ords-btn-dele">删除订单</a><a href="${pageContext.request.contextPath}/orders/topay.do?goodsId=1" class="ords-btn-com">去付款</a>
            </div>    
          </div>
        </div>
      ...
      <div id="tab5" class="weui-tab__bd-item">
        ...
        <div class="weui-panel weui-panel_access">
          ...
          <div class="weui-panel__ft">
            <div class="weui-cell weui-cell_access weui-cell_link oder-opt-btnbox">
              <a href="${pageContext.request.contextPath}/goods/comment.do?goodsId=1" class="ords-btn-com">去评价</a>
            </div>    
          </div>
        </div>
